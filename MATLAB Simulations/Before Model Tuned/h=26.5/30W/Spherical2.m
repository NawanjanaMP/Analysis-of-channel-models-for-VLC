...
P_rx_total =(P_rx);
% P_rx_initial =P_rx;
% %P_rx_final =P_rx - (1182-16638.*D+87847.*(D.^(2))-205980.*(D.^(3))+180978.*(D.^(4)));
% %P_rx_final =P_rx - (25.9-261.*D+925.*(D.^(2))-1091.*(D.^(3)));
% P_rx_final =P_rx - (1.24+1.39.*D-1.45.*(D.^(2)));
%P_rx_final =P_rx - (0.565.*D+1.35);
